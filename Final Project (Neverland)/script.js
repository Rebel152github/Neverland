...
document.addEventListener("readystatechange", function () {
    ...
    if (document.readyState === "complete") {
        ...
        document.querySelector("#loader img").style.scale = "0.12";
...
//---------------------page2text------------------------
function second(){
    document.querySelectorAll(".splitwords").forEach(function(elem){
        var clutter = "";
    ...
    gsap.from("#text1 .splitwords span",{
        opacity:0,
        scrollTrigger:{
            trigger:"#text1",
            start:"top 90%",
    ...
    gsap.from("#text2 .splitwords span",{
        opacity:0,
        scrollTrigger:{
            trigger:"#text2",
            start:"top 90%",
...
function menu(){
    ...
    document.querySelector("#menuicon").addEventListener("click",function(){
        if(flag===0){
            ...
            gsap.to("#menuicon #line1",{
                rotate:"-45deg"
            })
            gsap.to("#menuicon #line2",{
                rotate:"45deg"
            })
            gsap.to("#menu",{
                // display:"flex",
